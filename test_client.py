...
def do_client_latency(outdir, blind_freq, threshold):
    cmd = "build/lazy_db --period 1000 --num_workers 1 --num_reads 0 --num_writes 20 --normal 30 --num_records 1000000 --num_txns 10000000 --sub_threshold {0} --num_runs 1  --experiment 1 --blind_writes {1}"
...
def main():
    ...
    blind_frequencies = [10, 100, 1000, 10000]
